...
ENTITY_HEALTH_BAR_WIDTH = 30       # pixels; world-space health bar width for damaged entities
ENTITY_HEALTH_BAR_HEIGHT = 4       # pixels; world-space health bar thickness
ENTITY_HEALTH_BAR_Y_OFFSET = 10    # pixels above the entity rect; larger values lift bars higher
ENTITY_HEALTH_BAR_BG_COLOR = (50, 50, 50)  # RGB background tint for entity health bars
ENTITY_HEALTH_BAR_HIGH_COLOR = (60, 200, 80)  # RGB fill tint above 50% HP
ENTITY_HEALTH_BAR_MED_COLOR = (255, 255, 0)  # RGB fill tint between 25% and 50% HP
ENTITY_HEALTH_BAR_LOW_COLOR = (220, 60, 60)  # RGB fill tint at or below 25% HP
