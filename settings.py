...
SPECTRAL_BLADE_ORBIT_RADIUS = 8       # hilt offset: distance from player center to sword base
SPECTRAL_BLADE_ORBIT_SPEED = 180
SPECTRAL_BLADE_BLADE_LENGTH = 55      # sword length from hilt to tip
SPECTRAL_BLADE_BLADE_WIDTH = 6        # blade width for drawing
