...
def _draw_weapon_icon(surface: pygame.Surface, weapon_key: str, color: tuple[int, int, int]) -> None:
    ...
    if weapon_key == "arcane":
        ...
        pygame.draw.circle(surface, outline, (16, 16), 13)
        pygame.draw.circle(surface, shadow, (16, 16), 12)
        pygame.draw.circle(surface, mid_glow, (16, 16), 9)
        pygame.draw.circle(surface, highlight, (13, 12), 3)
        pygame.draw.circle(surface, core, (16, 16), 5)
        pygame.draw.circle(surface, center, (16, 16), 2)
        pygame.draw.line(surface, rune, (6, 10), (10, 7), 2)
        pygame.draw.line(surface, rune, (6, 10), (9, 14), 2)
        pygame.draw.line(surface, rune, (22, 6), (26, 10), 2)
        pygame.draw.line(surface, rune, (26, 10), (22, 13), 2)
        pygame.draw.line(surface, rune, (10, 25), (16, 27), 2)
        pygame.draw.line(surface, rune, (16, 27), (22, 25), 2)
        ...
        pygame.draw.circle(surface, detail, (16, 16), 12, 3)
        ...
        pygame.draw.circle(surface, outline, (16, 16), 13)
        pygame.draw.circle(surface, shadow, (16, 16), 12)
        pygame.draw.circle(surface, color, (16, 16), 9)
        pygame.draw.circle(surface, highlight, (13, 12), 3)
        pygame.draw.circle(surface, core, (16, 16), 5)
        pygame.draw.circle(surface, (55, 120, 70), (16, 16), 5, 1)
        rune_color = (115, 235, 105)
        pygame.draw.line(surface, rune_color, (6, 10), (10, 7), 2)
        pygame.draw.line(surface, rune_color, (6, 10), (9, 14), 2)
        pygame.draw.line(surface, rune_color, (22, 6), (26, 10), 2)
        pygame.draw.line(surface, rune_color, (26, 10), (22, 13), 2)
        pygame.draw.line(surface, rune_color, (10, 25), (16, 27), 2)
        pygame.draw.line(surface, rune_color, (16, 27), (22, 25), 2)
