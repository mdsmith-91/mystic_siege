...
- 4 hero classes in the original MVP roster (current: 8)
- 7 weapons/spells in the original MVP roster (current: 14)
...
- practical current co-op cap is 4 because duplicate heroes are blocked; the
  roster now has 8 heroes (Knight, Barbarian, Ranger, Rogue, Friar, Wizard, Warlock, Druid)
