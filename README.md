...
- 11 weapon types with 5 upgrade levels each
...
- Weapon ids remain string-based (`ArcaneBolt`, `BrambleSeeds`, `HolyNova`, `SpectralBlade`, `FlameBlast`, `FrostRing`, `HexOrb`, `LightningChain`, `Longbow`, `ShadowKnives`, `ThrowingAxes`) because hero data and upgrade choices reference them directly.
